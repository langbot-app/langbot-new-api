...
func AdminGetUserTokens(c *gin.Context) {
	...
	total, err := model.CountTokensByUserId(userId)
	if err != nil {
		common.ApiError(c, err)
		return
	}
...
func AdminSearchUserTokens(c *gin.Context) {
	...
	pageInfo := common.GetPageQuery(c)
	tokens, total, err := model.SearchTokensByUserId(userId, c.Query("keyword"), c.Query("token"), pageInfo.GetStartIdx(), pageInfo.GetPageSize())
	if err != nil {
		common.ApiError(c, err)
		return
	}
...
func AdminUpdateToken(c *gin.Context) {
	...
	if err := model.UpdateTokenAdmin(cleanToken); err != nil {
		common.ApiError(c, err)
		return
	}
	common.ApiSuccess(c, cleanToken)
...
func AdminDeleteToken(c *gin.Context) {
	...
	if err := model.DeleteTokenByIdAdmin(id); err != nil {
		common.ApiError(c, err)
		return
	}
	c.JSON(http.StatusOK, gin.H{
